...
CREATE INDEX `fk_comuna_region1_idx` ON `cc500270_db`.`comuna` (`region_id` ASC);


-- -----------------------------------------------------
-- Table `tarea2`.`avistamiento`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cc500270_db`.`avistamiento` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE INDEX `fk_domicilio_comuna1_idx` ON `cc500270_db`.`avistamiento` (`comuna_id` ASC);


-- -----------------------------------------------------
-- Table `tarea2`.`detalle_avistamiento`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cc500270_db`.`detalle_avistamiento` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `dia_hora` DATETIME NOT NULL,
  ...
  CONSTRAINT `fk_detalle_avistamiento_avistamiento1`
    ...
    REFERENCES `cc500270_db`.`avistamiento` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

CREATE INDEX `fk_detalle_avistamiento_avistamiento1_idx` ON `cc500270_db`.`detalle_avistamiento` (`avistamiento_id` ASC);


-- -----------------------------------------------------
-- Table `tarea2`.`foto`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cc500270_db`.`foto` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_foto_detalle_avistamiento1`
    ...
    REFERENCES `cc500270_db`.`detalle_avistamiento` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

CREATE INDEX `fk_foto_detalle_avistamiento1_idx` ON `cc500270_db`.`foto` (`detalle_avistamiento_id` ASC);
